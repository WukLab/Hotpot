...
EXPORT_SYMBOL(dsnvm_reg_begin_or_commit_xact_user);

void dsnvm_reg_begin_or_commit_xact_user_single(void *funcptr)
{
	dsnvmapi->begin_or_commit_xact_user_single = funcptr;
}
EXPORT_SYMBOL(dsnvm_reg_begin_or_commit_xact_user_single);
