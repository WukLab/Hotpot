#ifndef _INCLUDE_DSNVM_XACT_UTHASH_H_
#define _INCLUDE_DSNVM_XACT_UTHASH_H_
...
#ifndef uthash_fatal
#define uthash_fatal(msg) DSNVM_BUG(msg)        /* fatal error (out of memory,etc) */
#endif
...
#endif /* _INCLUDE_DSNVM_XACT_UTHASH_H_ */
